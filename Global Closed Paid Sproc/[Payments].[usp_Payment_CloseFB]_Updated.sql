...
ALTER PROCEDURE [Payments].[usp_Payment_CloseFB]  
...
@CheckDateToUse			AS [nvarchar](100)
AS      
...
** 10/13/2016 Jhobart Poblete		Add Check date to use. Options: (InvoiceDueDate, InvoiceCreateDate, ForwardDate, ExecutionDate, InPaymentNew)
**       
